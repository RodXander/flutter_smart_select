        ...
        child: Column(
          ...
          children: <Widget>[
            ListTile(
              title: Text(
                'smart_select',
                style: Theme.of(context).textTheme.headlineSmall!.merge(TextStyle(color: Colors.black87)),
              ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodyMedium!.merge(TextStyle(color: Colors.black54)),
                    ),
                    Container(height: 15),
                  ],
                ),
